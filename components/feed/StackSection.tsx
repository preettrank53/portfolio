...
export function StackSection({
  ...
  return (
    <motion.div
      ...
      className="grid grid-cols-1 md:grid-cols-4 gap-4 px-4 md:px-6 py-6 border-b border-[var(--border)] hover:bg-zinc-900/20 transition-colors group relative rounded-none items-center"
    >
      ...
      <div className="md:col-span-1">
        <h3 className="text-sm text-[var(--muted)] font-mono mt-1">
