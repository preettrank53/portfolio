            ...
            <div className="p-6 md:p-10 flex flex-col justify-between gap-8 border-t border-[var(--theme-border)] md:border-t-0">
              <div className="flex flex-col gap-3 mb-8">
                <a
                  ...
                  className="px-6 py-2 border border-[var(--theme-border)] text-[var(--theme-text)] font-medium text-sm rounded-md hover:bg-[var(--theme-hover)] transition-colors inline-flex justify-center items-center relative z-20 w-full"
                >
                  Email Me
                </a>
